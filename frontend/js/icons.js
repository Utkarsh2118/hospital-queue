...
const ICONS = {
  ...
  baby: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="10" r="6"/><circle cx="9.5" cy="9" r="0.6" fill="currentColor"/><circle cx="14.5" cy="9" r="0.6" fill="currentColor"/><path d="M9 12.5c1 1 5 1 6 0"/><path d="M12 16v5"/></svg>`,
